...
#add arugment speficies which commandline options, in this case -f is the input file
    ...
    final.most_common()
     #plot user issues
    plot_one_data(range(len(final)), final.values(), final.keys(), "User Issue Categories", "Conversations about that User Issue", "User Issue Categories Firefox 63 Week 3")
    ...
    plt.title("User Issue Categories Firefox 63 Release Week 3")
    ...
    #plt.ylabel("# Support Conversations")
    plt.title("New User Issue Categories Firefox 63 Release Week 3")
    ...
    plt.title("User Issue Languages Supported Firefox 63 Release Week 3")
    plt.show()
    ...
    plt.title("User Issue categories Firefox 63 Release Week 2 to Week 3")
    plt.show()
